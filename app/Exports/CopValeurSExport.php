...
class CopValeurSExport implements FromCollection, WithHeadings, WithStyles, WithColumnWidths
{
    /**
    ...
    public function collection()
    {
        ...
        $this->data = DB::table('copValeurs as cv')
            ...
            ->select(
                ...
                'cv.ecartType',
                DB::raw("CONCAT(cc.\"cibleSemestre\", ' ', cc.unite) AS cibleS_with_unit"),
                // 'cv.ecartP',
